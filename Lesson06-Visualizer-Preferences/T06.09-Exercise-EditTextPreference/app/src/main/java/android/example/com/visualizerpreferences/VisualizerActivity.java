...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        loadMinSizeFromPreferences(sharedPreferences);
    ...
    private void loadMinSizeFromPreferences(SharedPreferences sharedPreferences) {
        float scale = Float.parseFloat(sharedPreferences.getString(getString(R.string.pref_size_key),getString(R.string.pref_size_default)));
